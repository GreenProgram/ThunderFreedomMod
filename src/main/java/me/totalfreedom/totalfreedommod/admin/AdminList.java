...
public class AdminList extends FreedomService
{
    ...
    public boolean isTelnetClanAdmin(CommandSender sender)
    {
        ...
        return admin.getRank().ordinal() >= Rank.TELNET_CLAN_ADMIN.ordinal();
    }
    ...
    public void deactivateOldEntries(boolean verbose)
    {
        for (Admin admin : allAdmins.values())
        {
            ...
            if (verbose)
            {
                FUtil.adminAction("GodFreedomMod", "Deactivating superadmin " + admin.getName() + ", inactive for " + lastLoginHours + " hours", true);
            }
