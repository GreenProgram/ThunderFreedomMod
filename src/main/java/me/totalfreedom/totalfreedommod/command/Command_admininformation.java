...
public class Command_admininformation extends FreedomCommand
{
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        sender.sendMessage(ChatColor.GOLD + "After you've gained knowledge of most of the players, commands,");
        ...
        sender.sendMessage(ChatColor. AQUA + "The website can be found at http://thunderfreedom.boards.net/");
        return true;
    }
}
