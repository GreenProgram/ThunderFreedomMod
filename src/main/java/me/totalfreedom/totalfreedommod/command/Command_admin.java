...
@CommandPermissions(level = Rank.TRFDEVELOPER, source = SourceType.BOTH, blockHostConsole = false)
@CommandParameters(description = "Manage admins in game.", usage = "/<command> <list | clean | reload | | setrank <username> <rank> | <add | remove | info> <username>>", aliases = "sys")
