...
public enum Rank implements Displayable
{
    ...
    TRFDEVELOPER("a", "Developer", Type.ADMIN, "Dev", ChatColor.DARK_PURPLE),
    ADMINISTRATOR("an", "Administrator", Type.ADMIN, "Admin", ChatColor.DARK_RED),
    ...
    TRFDEVELOPER_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.DARK_PURPLE),
    ADMINISTRATOR_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.DARK_PURPLE);
    ...
    public Rank getConsoleVariant()
    {
        switch (this)
        {
            ...
            case TRFDEVELOPER:
            case TRFDEVELOPER_CONSOLE:
                return TRFDEVELOPER_CONSOLE;
            case ADMINISTRATOR:
            case ADMINISTRATOR_CONSOLE:
                return ADMINISTRATOR_CONSOLE;
            default:
                return null;
        }
    }
